...
public class DefaultEmptyView extends EmptyViewProxy implements View.OnClickListener {
...
//    private onLrRetryClickListener mListener = null;
    ...
    public DefaultEmptyView(Context context) {
        ...
        retryButton = (Button) retryView.findViewById(R.id.lr_proxy_button_retry);

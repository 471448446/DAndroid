...
//                shareLink = shareLink.replace(img2.getRef(), "<img src=\"" + img2.getSrc() + "\" onclick=\""+getImageClickListener()+"\"width=\"100%\" height=\"auto\">");
...
//
//    private String getImageClickListener() {
//        return "window.app.openImage(this.src)";
//    }

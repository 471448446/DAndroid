...
import better.app.chinawisdom.util.extenions.gone
import better.app.chinawisdom.util.extenions.isVisiable
import better.app.chinawisdom.util.extenions.visiable
...
//        read_readView.showBook("第九卷　　　　　【汉纪一】", "book/baihuazizhitongjian/9_zizhitongjianbaihuaban_资治通鉴第九卷.txt")
    ...
    override fun onStart() {
        super.onStart()
        read_readView.setSlideAnimation(SettingConfig.bookAnimation)
    }
